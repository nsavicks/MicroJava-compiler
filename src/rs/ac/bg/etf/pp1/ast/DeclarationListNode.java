...
public class DeclarationListNode extends DeclarationList {

    private DeclarationList DeclarationList;
    private Declaration Declaration;

    public DeclarationListNode (DeclarationList DeclarationList, Declaration Declaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationListNode(\n");
