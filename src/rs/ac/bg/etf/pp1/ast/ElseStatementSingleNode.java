...
public class ElseStatementSingleNode extends ElseStatementSingle {

    private Else Else;
    private Statement Statement;

    public ElseStatementSingleNode (Else Else, Statement Statement) {
        this.Else=Else;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ElseStatementSingleNode(\n");
